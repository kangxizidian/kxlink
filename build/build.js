  ...
  render: function() {
    return (
      React.DOM.div( {className:"main row"}, 
        ...
        React.DOM.div( {className:"col-md-1"}, backlinklist( {links:this.state.backlink, openKangxi:this.openKangxi} )),
  ...
  render: function() {
    ...
    return (
      React.DOM.div(null, "十三經 " ,
       React.DOM.span( {className:"pagename label label-success"}, pagename),React.DOM.span(null, this.state.selstart+":"+this.state.sellength),
...
var backlinklist = React.createClass({displayName: 'backlinklist',
  ...
  render: function() {
    return (
      React.DOM.div( {onClick:this.dolink}, 
        this.links() 
      )
    );
  }
...
"而福謙人道惡盈而好謙．謙尊而光．卑而不可踰．君子之終也．象曰．地中有山．謙．君子以裒多益寡．稱物平施．初"+
