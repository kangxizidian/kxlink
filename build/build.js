...
require.register("kxlink-main/index.js", function(exports, require, module){
/** @jsx React.DOM */
  ...
  render: function() {
    return (
      React.DOM.div( {className:"main row"}, 
        React.DOM.div( {ref:"kangxidiv", className:"kangxi col-md-6"}, 
        kangxi( 
        ...
        React.DOM.div( {className:"col-md-1"}, backlinklist( 
          {links:this.state.backlink, 
          linkable:this.linkable(),
          addLink:this.addLink, 
          openKangxi:this.openKangxi} )
        ),
        React.DOM.div( {ref:"j13div", className:"j13 col-md-5"}, 
          j13( 
            {openJ13:this.openJ13, 
            openKangxi:this.openKangxi, 
...
require.register("kxlink-kangxi/index.js", function(exports, require, module){
/** @jsx React.DOM */
...
var $=Require('jquery');
var kangxi = React.createClass({displayName: 'kangxi',
  getInitialState: function() {
...
//<kangxibuttons onShowPage={this.onShowPage}/>   
    ...
    return (
      React.DOM.div(null, 
        " 開放康熙字典",React.DOM.span( {className:"pagename label label-success"}, pagename),
        React.DOM.span(null, this.props.start,":",this.props.len),      
...
require.register("kxlink-j13/index.js", function(exports, require, module){
/** @jsx React.DOM */
var j13buttons=Require("j13buttons");
var surface=Require("surface");
var $=Require("jquery")
var j13 = React.createClass({displayName: 'j13',
  getInitialState: function() {
  ...
  render: function() {
    ...
    return (  
      React.DOM.div(null, "十三經 " ,
       React.DOM.span( {className:"pagename label label-success"}, pagename),
       React.DOM.span(null, this.props.start+":"+this.props.len),
...
require.register("kxlink-backlinklist/index.js", function(exports, require, module){
/** @jsx React.DOM */

//var othercomponent=Require("other"); 
var backlinklist = React.createClass({displayName: 'backlinklist',
  getInitialState: function() {
    return {bar: "world"};
  },
  links:function() {
    ...
    return this.props.links.map(function(L,i){
      return React.DOM.a( {key:i, className:"btn btn-info",
      'data-start':L.start,
      'data-len':L.len}, L.name)
    })
  },
  openpage:function(e) {
  ...
  render: function() {
    ...
    return (
      React.DOM.div(null, 
      React.DOM.a( {className:"btn btn-primary "+disable, 
         onClick:this.props.addLink}, 
       React.DOM.img(  {src:"link.png"})
      ),
      React.DOM.div( {align:"center", onClick:this.openpage}, 
        this.links() 
      )
      )
    );
...
require.register("ksanadoc-surface/index.js", function(exports, require, module){
/** @jsx React.DOM */
var $=Require("jquery");
var token = React.createClass({displayName: 'token',
  render:function() {
    if (this.props.replaceto)
          return React.DOM.span( {className:this.props.cls, 'data-to':this.props.replaceto, 'data-n':this.props.n}, this.props.ch)
    else  return React.DOM.span( {className:this.props.cls, 'data-n':this.props.n}, this.props.ch)
  }
})
...
//          replaceto=R[0].payload.text;
      ...
      xml.push(token( {key:i, cls:classes, n:i, ch:ch, replaceto:replaceto}));
    };
  ...
  render: function() {
    ...
    return (
      React.DOM.div( {className:"surface"}, 
            React.DOM.div( {ref:"surface", tabIndex:"0", onKeyDown:this.keydown, onMouseUp:this.mouseup} 
              , xml),
...
require.register("kxlink-help/index.js", function(exports, require, module){
/** @jsx React.DOM */
...
require.register("kxlink-kangxibuttons/index.js", function(exports, require, module){
/** @jsx React.DOM */

//var othercomponent=Require("other"); 
var kangxibuttons = React.createClass({displayName: 'kangxibuttons',
  getInitialState: function() {
    return {pagename:" "};
  },
  ...
  render: function() {
    return (
      React.DOM.div( {onClick:this.fetchpage}, 
        React.DOM.a( {className:"btn btn-primary"}, "福"),
        React.DOM.a( {className:"btn btn-primary"}, "威"),
        React.DOM.a( {className:"btn btn-primary"}, "遏"),
        React.DOM.a( {className:"btn btn-primary"}, "應")
...
var j13buttons = React.createClass({displayName: 'j13buttons',
  ...
  render: function() {
    return ( 
      React.DOM.div( {onClick:this.fetchpage}, 
        React.DOM.a( {className:"btn btn-primary"}, "乾"),
        React.DOM.a( {className:"btn btn-primary"}, "洪範"),
        React.DOM.a( {className:"btn btn-primary"}, "大有"),
        React.DOM.a( {className:"btn btn-primary"}, "武成"),
        React.DOM.a( {className:"btn btn-primary"}, "僖24")
      )
    );
  }
});
...
require.register("kxlink-links/index.js", function(exports, require, module){
/** @jsx React.DOM */
...
require.register("yaml/index.js", function(exports, require, module){
﻿
module.exports={kdoc:require('./kdoc')};
});
require.register("yaml/kdoc.js", function(exports, require, module){
/*
...
require.register("facebook-react/react-with-addons.js", function(exports, require, module){
/**
...
require.register("kxlink/index.js", function(exports, require, module){
var boot=require("boot");
boot("kxlink","main","main");
});
require.register("kxlink/kangxipages.js", function(exports, require, module){
...
require.register("kxlink/j13pages.js", function(exports, require, module){
...
require.register("kxlink/markups.js", function(exports, require, module){
module.exports=[
{name:"福",start:72,len:4, payload:{type:"link",name:"洪範",start:203,len:4}},
{name:"威",start:35,len:4, payload:{type:"link",name:"大有",start:212,len:4}},
{name:"威",start:47,len:4, payload:{type:"link",name:"洪範",start:793,len:4}},
...
require.alias("ksanaforge-boot/index.js", "kxlink/deps/boot/index.js");
require.alias("ksanaforge-boot/index.js", "kxlink/deps/boot/index.js");
require.alias("ksanaforge-boot/index.js", "boot/index.js");
require.alias("ksanaforge-boot/index.js", "ksanaforge-boot/index.js");
require.alias("brighthas-bootstrap/dist/js/bootstrap.js", "kxlink/deps/bootstrap/dist/js/bootstrap.js");
require.alias("brighthas-bootstrap/dist/js/bootstrap.js", "kxlink/deps/bootstrap/index.js");
...
require.alias("component-jquery/index.js", "kxlink/deps/jquery/index.js");
require.alias("component-jquery/index.js", "jquery/index.js");

require.alias("kxlink-main/index.js", "kxlink/deps/main/index.js");
require.alias("kxlink-main/index.js", "kxlink/deps/main/index.js");
require.alias("kxlink-main/index.js", "main/index.js");
require.alias("kxlink-main/index.js", "kxlink-main/index.js");
require.alias("kxlink-kangxi/index.js", "kxlink/deps/kangxi/index.js");
require.alias("kxlink-kangxi/index.js", "kxlink/deps/kangxi/index.js");
require.alias("kxlink-kangxi/index.js", "kangxi/index.js");
require.alias("kxlink-kangxi/index.js", "kxlink-kangxi/index.js");
require.alias("kxlink-j13/index.js", "kxlink/deps/j13/index.js");
require.alias("kxlink-j13/index.js", "kxlink/deps/j13/index.js");
require.alias("kxlink-j13/index.js", "j13/index.js");
require.alias("kxlink-j13/index.js", "kxlink-j13/index.js");
require.alias("kxlink-backlinklist/index.js", "kxlink/deps/backlinklist/index.js");
require.alias("kxlink-backlinklist/index.js", "kxlink/deps/backlinklist/index.js");
require.alias("kxlink-backlinklist/index.js", "backlinklist/index.js");
require.alias("kxlink-backlinklist/index.js", "kxlink-backlinklist/index.js");
require.alias("ksanadoc-surface/index.js", "kxlink/deps/surface/index.js");
require.alias("ksanadoc-surface/index.js", "kxlink/deps/surface/index.js");
require.alias("ksanadoc-surface/index.js", "surface/index.js");
require.alias("ksanadoc-surface/index.js", "ksanadoc-surface/index.js");
require.alias("kxlink-help/index.js", "kxlink/deps/help/index.js");
require.alias("kxlink-help/index.js", "kxlink/deps/help/index.js");
require.alias("kxlink-help/index.js", "help/index.js");
require.alias("kxlink-help/index.js", "kxlink-help/index.js");
require.alias("kxlink-kangxibuttons/index.js", "kxlink/deps/kangxibuttons/index.js");
require.alias("kxlink-kangxibuttons/index.js", "kxlink/deps/kangxibuttons/index.js");
require.alias("kxlink-kangxibuttons/index.js", "kangxibuttons/index.js");
require.alias("kxlink-kangxibuttons/index.js", "kxlink-kangxibuttons/index.js");
require.alias("kxlink-j13buttons/index.js", "kxlink/deps/j13buttons/index.js");
require.alias("kxlink-j13buttons/index.js", "kxlink/deps/j13buttons/index.js");
require.alias("kxlink-j13buttons/index.js", "j13buttons/index.js");
require.alias("kxlink-j13buttons/index.js", "kxlink-j13buttons/index.js");
require.alias("kxlink-links/index.js", "kxlink/deps/links/index.js");
require.alias("kxlink-links/index.js", "kxlink/deps/links/index.js");
require.alias("kxlink-links/index.js", "links/index.js");
require.alias("kxlink-links/index.js", "kxlink-links/index.js");
require.alias("yaml/index.js", "kxlink/deps/yaml/index.js");
require.alias("yaml/kdoc.js", "kxlink/deps/yaml/kdoc.js");
require.alias("yaml/index.js", "kxlink/deps/yaml/index.js");
require.alias("yaml/index.js", "yaml/index.js");
require.alias("yaml/index.js", "yaml/index.js");
require.alias("facebook-react/react-with-addons.js", "kxlink/deps/react/react-with-addons.js");
require.alias("facebook-react/react-with-addons.js", "kxlink/deps/react/index.js");
require.alias("facebook-react/react-with-addons.js", "react/index.js");
require.alias("facebook-react/react-with-addons.js", "facebook-react/index.js");
require.alias("kxlink/index.js", "kxlink/index.js");